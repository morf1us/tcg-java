...
(assert (or ab_6 (= temp_3_0 (and temp_2_0 (< a_1 0)))))
(assert (or ab_7 (= y_5 (+ y_4 1))))
(assert (or ab_6 (= temp_4_0 (and temp_3_0 (< a_1 0)))))
(assert (or ab_7 (= y_6 (+ y_5 1))))
(assert (or ab_6 (= temp_5_0 (and temp_4_0 (< a_1 0)))))
(assert (or ab_7 (= y_7 (+ y_6 1))))
(assert (or ab_6 (= temp_6_0 (and temp_5_0 (< a_1 0)))))
